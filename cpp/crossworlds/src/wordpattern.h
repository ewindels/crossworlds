...
class WordPattern {
  public:
    ...
    friend class OrthogonalPattern;
  ...
  protected:
    ...
    std::map<int, OrthogonalPattern> d_orthogonalMap;
    std::string d_strRepr;
};
...
{
  protected:
    WordPattern* d_pattern_p;
    int d_index;

  public:
    WordPattern* pattern();
    int index();
    void updateCandidates(char letter);
};
